...
class ResNet(nn.Module):
    def __init__(self,block,list_of_num_layers, list_of_out_dims, userelu=True):
        ...
        self.ly0 = nn.Sequential(*[conv1, bn1, relu, pool1])


        self.layer1 = block(64, list_of_out_dims[0], False, userelu=True)
        self.layer2 = block(list_of_out_dims[0], list_of_out_dims[1], False, userelu=True)
        self.layer3 = block(list_of_out_dims[1], list_of_out_dims[2], True, userelu=True)
        self.layer4 = block(list_of_out_dims[2], list_of_out_dims[3], True, userelu=opt.last_relu)
...
def resnet10():
    return ResNet(SimpleBlock, [1,1,1,1], [64,128,256,512], userelu=opt.last_relu)